...
public interface UsuarioLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UsuarioLocalServiceUtil} to access the usuario local service. Add custom service methods to <code>mx.com.cuervo.rutas.service.impl.UsuarioLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
