...
/**
 * Provides the local service interface for Ruta. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RutaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RutaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RutaLocalServiceUtil} to access the ruta local service. Add custom service methods to <code>mx.com.cuervo.rutas.service.impl.RutaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public Ruta addRuta(
	...
	public Ruta deleteRuta(long rutaId, ServiceContext serviceContext)
	...
	public List<Ruta> getRutas(
		long groupId, int start, int end, OrderByComparator<Ruta> obc);
	...
	public Ruta updateRuta(
			long userId, long rutaId, String nombreRuta, long capacidad,
			long disponibilidad, ServiceContext serviceContext)
		throws PortalException, SystemException;
