...
public class UsuarioUtil {
	 ...
	 */
	public static List<Usuario> findByG_R(long groupId, long rutaId) {
	 ...
	 */
	public static List<Usuario> findByG_R(
	 ...
	 */
	public static Usuario findByG_R_First(
			long groupId, long rutaId,
			OrderByComparator<Usuario> orderByComparator)
		throws mx.com.cuervo.rutas.exception.NoSuchUsuarioException {
	 ...
	 */
	public static Usuario fetchByG_R_First(
		long groupId, long rutaId,
		OrderByComparator<Usuario> orderByComparator) {
	 ...
	 * @throws NoSuchUsuarioException if a matching usuario could not be found
	 */
	public static Usuario findByG_R_Last(
			long groupId, long rutaId,
			OrderByComparator<Usuario> orderByComparator)
		throws mx.com.cuervo.rutas.exception.NoSuchUsuarioException {
	 ...
	 */
	public static Usuario fetchByG_R_Last(
		long groupId, long rutaId,
		OrderByComparator<Usuario> orderByComparator) {
	 ...
	 */
	public static Usuario[] findByG_R_PrevAndNext(
			long usuarioId, long groupId, long rutaId,
			OrderByComparator<Usuario> orderByComparator)
		throws mx.com.cuervo.rutas.exception.NoSuchUsuarioException {

		return getPersistence().findByG_R_PrevAndNext(
			usuarioId, groupId, rutaId, orderByComparator);
	}
	...
	private static ServiceTracker<UsuarioPersistence, UsuarioPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(UsuarioPersistence.class);

		ServiceTracker<UsuarioPersistence, UsuarioPersistence> serviceTracker =
			new ServiceTracker<UsuarioPersistence, UsuarioPersistence>(
				bundle.getBundleContext(), UsuarioPersistence.class, null);
